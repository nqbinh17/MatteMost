...
WebUI.click(findTestObject('Page Boyris Mattermost/span_Edit Team Name'))

WebUI.setText(findTestObject('Page Boyris Mattermost/input_Team Name_teamName'), 'Boyris')
