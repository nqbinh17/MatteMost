...
WebUI.click(findTestObject('Account Settings/span_Edit Message Display'))

WebUI.click(findTestObject('Account Settings/label_Compact Fit as many messages on the screen as we can'))
