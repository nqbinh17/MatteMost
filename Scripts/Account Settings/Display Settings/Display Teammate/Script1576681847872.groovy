...
WebUI.click(findTestObject('Account Settings/span_Edit Teammate'))

WebUI.click(findTestObject('Account Settings/input_Teammate Name Display_name_formatFormat'))
